...
class Galeria {
    private $db;
    private $nombreTabla = 'galeria';
    private $uploadDir = 'uploads/galeria/'; // Directorio para guardar las imágenes
    ...
    public function agregargaleria($imagen) {
    ...
    public function actualizargaleria($id, $imagen) {
        // Primero, obtener el nombre del archivo de imagen anterior
        $imagenAnterior = $this->obtenergaleriaPorId($id)['img'];
    ...
    public function eliminargaleria($id) {
        ...
        $imagenABorrar = $this->obtenergaleriaPorId($id)['img'];
        if ($imagenABorrar) {
