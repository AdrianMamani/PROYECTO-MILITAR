    ...
    <?php else: ?>
        <?php foreach ($videos as $video): ?>
            <tr>
                ...
                <td><?= htmlspecialchars($video['titulo_evento']) ?></td>
                <td>
                    <button type="button" class="btn btn-warning btn-sm edit-video-button"
                        data-id="<?= htmlspecialchars($video['id']) ?>"
                        data-codigo="<?= htmlspecialchars($video['codigo_video']) ?>"
                        data-evento-id="<?= htmlspecialchars($video['evento_id']) ?>"
                        data-evento-nombre="<?= htmlspecialchars($video['titulo_evento']) ?>"
...
<div class="modal fade" id="addVideoModal" tabindex="-1" role="dialog" aria-labelledby="addVideoModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form id="addVideoForm" action="index.php?action=videoevento/store" method="POST">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group mt-3">
            <label for="evento_video_id">Evento</label>
            <select class="form-control" id="evento_video_id" name="evento_id" required>
