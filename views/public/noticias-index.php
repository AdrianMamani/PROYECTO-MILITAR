...
<head>
    ...
    <title>Portal de Noticias - Sistema Militar</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mb-4">
                    <h5><i class="fas fa-shield-alt me-2"></i>Portal Militar</h5>
                    <p class="text-muted">Centro oficial de comunicaciones e información militar. Manteniendo informado al personal con noticias verificadas y comunicados oficiales.</p>
                    <div class="d-flex gap-3">
                        <span class="badge bg-success">Seguro</span>
                        <span class="badge bg-warning">Clasificado</span>
                        <span class="badge bg-info">Oficial</span>
                    </div>
                </div>
                <div class="col-lg-2 mb-4">
                    <h6>Navegación</h6>
                    <ul class="list-unstyled">
                        <li><a href="index.php?action=noticias-public/index" class="text-muted">Noticias</a></li>
                        <li><a href="index.php?action=finanzas-public/index" class="text-muted">Finanzas</a></li>
                        <li><a href="#" class="text-muted">Comunicados</a></li>
                ...
                <div class="col-lg-3 mb-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="#" class="text-muted">Política de Seguridad</a></li>
                        <li><a href="#" class="text-muted">Términos de Uso</a></li>
                        <li><a href="#" class="text-muted">Protocolo</a></li>
                    </ul>
                </div>
                <div class="col-lg-3 mb-4">
                    <h6>Seguridad</h6>
                    <p class="text-muted small">Esta información está clasificada y es de uso exclusivo del personal autorizado.</p>
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <p class="text-muted small mb-0">&copy; <?= date('Y') ?> Portal Militar. Todos los derechos reservados.</p>
                </div>
                <div class="col-md-6 text-md-end">
                    <p class="text-muted small mb-0">
                        <i class="fas fa-shield-alt text-success me-1"></i>
                        Sistema Seguro y Verificado
                    </p>
                </div>
            </div>
        </div>
