...
class GaleriaPublicaController {
    ...
    public function mostrarGaleria() {
        ...
        $videosLogro   = $this->modeloVideoLogro->getAll();
               ...
               // Relacionar imágenes con logros (solo una principal)
        // $imagenesPorLogro = [];
        // foreach ($imagenes as $img) {
        //     $id = $img['logro_id'];
        //     if (!isset($imagenesPorLogro[$id])) {
        //         $imagenesPorLogro[$id] = './uploads/logros/' . $img['nombre_imagen'];
        //     }
        // }

        require_once './views/galeria.php'; // Vista general
    }
