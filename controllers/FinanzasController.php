    ...
    public function agregar() {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            $datos = [
                ...
                'nov' => $_POST['nov'],
                'dic' => $_POST['dic'],
                'deuda_2025' => $_POST['deuda_2025'],
                'deuda_2024' => $_POST['deuda_2024'],
                'deuda_2023' => $_POST['deuda_2023'],
                'deuda_2022' => $_POST['deuda_2022'],
                'deuda_2021' => $_POST['deuda_2021'],
                'otros_deudas' => $_POST['otros_deudas'],
                'lugar' => $_POST['lugar'],
                'fecha' => $_POST['fecha']
            ];
